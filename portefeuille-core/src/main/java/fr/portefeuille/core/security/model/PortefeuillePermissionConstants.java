...
public class PortefeuillePermissionConstants extends CorePermissionConstants {

	//-------------------------------------------------------------------------------
	// "Object" permissions (relate to an object in particular)
	// See also CorePermisionConstants (parent class)

	// Add contants of the form public static final String MY_PERMISSION_NAME = "MY_PERMISSION_NAME"; here
