package fr.portefeuille.core.business.common.model.embeddable;
...
import fr.portefeuille.core.business.common.util.PortefeuilleLocale;
...
public class LocalizedText extends AbstractLocalizedText {
	...
	public String get(Locale locale) {
		...
		if (PortefeuilleLocale.FRENCH.getLanguage().equals(locale.getLanguage())) {
			return getFr();
		} else if (PortefeuilleLocale.ENGLISH.getLanguage().equals(locale.getLanguage())) {
			return getEn();
		} else {
			return get(PortefeuilleLocale.DEFAULT);
		}
	}
