package fr.portefeuille.core.business.common.model.comparator;
...
public class LocalizedTextComparator extends AbstractLocalizedTextComparator<LocalizedText> {
	...
	private static final LocalizedTextComparator INSTANCE = new LocalizedTextComparator(PortefeuilleLocale.DEFAULT, PortefeuilleLocale.comparator());
