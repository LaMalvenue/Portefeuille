package fr.portefeuille.core.business.user.typedescriptor;
...
public abstract class UserTypeDescriptor<U extends User> implements Serializable {
	...
	public static final UserTypeDescriptor<TechnicalUser> TECHNICAL_USER = new UserTypeDescriptor<TechnicalUser>(
		TechnicalUser.class,
		() -> new TechnicalUser(),
		"technicalUser"
	) {
	...
	public static final UserTypeDescriptor<BasicUser> BASIC_USER = new UserTypeDescriptor<BasicUser>(
		BasicUser.class,
		() -> new BasicUser(),
		"basicUser"
	) {
	...
	public static final UserTypeDescriptor<User> USER = new UserTypeDescriptor<User>(
		User.class,
		() -> new User(),
		"user"
	) {
	...
	protected UserTypeDescriptor(Class<U> clazz, SerializableSupplier<U> supplier, String resourceKeyBase) {
