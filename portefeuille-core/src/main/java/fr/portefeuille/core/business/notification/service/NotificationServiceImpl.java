...
public class NotificationServiceImpl extends AbstractNotificationServiceImpl implements INotificationService {
	...
	@Autowired
	private IPortefeuilleNotificationUrlBuilderService notificationUrlBuilderService;

	@Autowired
	private IPortefeuilleNotificationContentDescriptorFactory contentDescriptorFactory;
