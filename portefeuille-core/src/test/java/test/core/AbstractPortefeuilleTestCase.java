...
import fr.portefeuille.core.business.referencedata.service.ICityService;
...
import test.core.config.spring.PortefeuilleCoreTestCommonConfig;

@ContextConfiguration(
		classes = PortefeuilleCoreTestCommonConfig.class,
		inheritInitializers = true
)
public abstract class AbstractPortefeuilleTestCase extends AbstractTestCase {
