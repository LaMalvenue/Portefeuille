package fr.portefeuille.web.application.common.util;

public final class CssClassConstants {

	public static final String CELL_HIDDEN_LG_AND_LESS = "d-none";
	public static final String CELL_HIDDEN_MD_AND_LESS = "d-none d-lg-table-cell";
