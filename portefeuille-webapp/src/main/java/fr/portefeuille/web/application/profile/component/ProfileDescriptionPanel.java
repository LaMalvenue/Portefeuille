package fr.portefeuille.web.application.profile.component;
	...
	public ProfileDescriptionPanel(String id, IModel<User> userModel) {
		...
		add(
			new BlankLink("passwordEdit")
				...
				.add(
					Condition.isTrue(Model.of(securityManagementService.getOptions(PortefeuilleSession.get().getUser()).isPasswordUserUpdateEnabled()))
						.thenShow()
				),
