...
import fr.portefeuille.core.security.model.PortefeuillePermissionConstants;
import fr.portefeuille.core.util.binding.Bindings;
import fr.portefeuille.web.application.administration.form.UserGroupPopup;
			...
			DataTableBuilder.start(ReadOnlyCollectionModel.of(userGroupListModel, GenericEntityModel.factory()))
				...
				.addActionColumn()
					.addConfirmAction(ActionRenderers.delete())
						...
						.whenPermission(PortefeuillePermissionConstants.DELETE)
