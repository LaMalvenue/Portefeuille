package fr.portefeuille.web.application.console.notification.demo.page;
...
import fr.portefeuille.core.business.notification.service.INotificationService;
import fr.portefeuille.core.business.user.model.User;
import fr.portefeuille.web.application.PortefeuilleSession;
import fr.portefeuille.web.application.console.notification.demo.template.ConsoleNotificationDemoTemplate;
import fr.portefeuille.web.application.console.notification.demo.util.NotificationDemoEntry;
...
public class ConsoleNotificationDemoIndexPage extends ConsoleNotificationDemoTemplate {
	...
	public ConsoleNotificationDemoIndexPage(PageParameters parameters) {
		...
		add(new Link<Void>("sendExample") {
			...
			public void onClick() {
				try {
					notificationService.sendExampleNotification(PortefeuilleSession.get().getUser());
