						...
						.add(
							new CoreLabel("originalAuthentication", new IModel<String>() {
								...
								public String getObject() {
									return PortefeuilleSession.get().getOriginalAuthentication() != null ? PortefeuilleSession.get().getOriginalAuthentication().getName() : null;
								}
							})
								.hideIfEmpty(),
							new CoreLabel("userFullName", BindingModel.of(PortefeuilleSession.get().getUserModel(), Bindings.user().fullName()))
								.hideIfEmpty()
						);
				}
			}
		...
		add(
			new AjaxLink<Void>("signInAsMe") {
				...
				public void onClick(AjaxRequestTarget target) {
					try {
						PortefeuilleSession.get().signInAsMe();
						PortefeuilleSession.get().success(getString("authentication.back.success"));
					} catch (Exception e) {
				...
				protected void onConfigure() {
					super.onConfigure();
					setVisible(PortefeuilleSession.get().getOriginalAuthentication() != null);
				}
			},
