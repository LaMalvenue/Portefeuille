...
import fr.portefeuille.web.application.administration.component.tab.AdministrationTechnicalUserDetailTabMainInformationPanel;
import fr.portefeuille.web.application.administration.component.tab.AdministrationTechnicalUserDetailTabSecurityPanel;
import fr.portefeuille.web.application.administration.form.UserPasswordEditPopup;
...
import fr.portefeuille.web.application.common.util.BootstrapTabsUtils;
import fr.portefeuille.web.application.navigation.link.LinkFactory;
							...
							.add(
								new Condition() {
									...
									public boolean applies() {
										...
										User currentUser = PortefeuilleSession.get().getUser();
