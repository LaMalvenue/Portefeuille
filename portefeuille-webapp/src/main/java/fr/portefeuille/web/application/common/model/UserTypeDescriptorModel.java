package fr.portefeuille.web.application.common.model;
...
public abstract class UserTypeDescriptorModel<U extends User> extends LoadableDetachableModel<UserTypeDescriptor<U>> {
	...
	public static final <U extends User> UserTypeDescriptorModel<U> fromClass(Class<? extends U> userClass) {
		return fromClass(Model.of(userClass));
	}

	public static final <U extends User> UserTypeDescriptorModel<U> fromClass(IModel<? extends Class<? extends U>> userClassModel) {
