package fr.portefeuille.web.application.profile.page;
...
import fr.portefeuille.web.application.profile.component.ProfileDescriptionPanel;
import fr.portefeuille.web.application.profile.template.ProfileTemplate;
...
public class ProfilePage extends ProfileTemplate {
	...
	protected final IModel<User> userModel = PortefeuilleSession.get().getUserModel();
